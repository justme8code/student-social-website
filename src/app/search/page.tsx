        ...
        <div className="w-full h-screen  dark:bg-neutral-900 flex flex-col items-center p-2">
            ...
            <Navbar2>
                <div className="w-full max-w-4xl ">
                    <div
                        className="flex  flex-col text-black dark:text-white  bg-neutral-100 rounded-lg  bg-neutral-2*00  dark:bg-neutral-800 w-full p-2 gap-2 focus-within:ring-purple-500 dark:focus-within:ring-purple-500">
